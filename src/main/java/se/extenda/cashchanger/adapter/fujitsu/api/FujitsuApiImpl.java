...
import se.extenda.cashchanger.adapter.fujitsu.UnexpectedWeightChangeResponse;
...
import se.extenda.cashchanger.adapter.fujitsu.response.ErrorResponseCode;
import se.extenda.cashchanger.adapter.fujitsu.response.GeneralFujitsuResponse;
...
import se.extenda.cashchanger.adapter.fujitsu.response.InterruptResponse;
import se.extenda.cashchanger.adapter.fujitsu.response.IsZeroResponse;
...
import se.extenda.cashchanger.adapter.fujitsu.response.UnexpectedWeightResponse;
